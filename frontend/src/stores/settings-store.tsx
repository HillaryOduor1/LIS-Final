...
export const SettingsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const applySettingsToDOM = (appSettings: AppSettings) => {
    ...
    // 2. Brand Colors – map to the CSS variables used in index.css
    root.style.setProperty("--primary", appSettings.theme.primaryColor);
    root.style.setProperty("--accent", appSettings.theme.secondaryColor); // secondary becomes accent
    root.style.setProperty("--secondary", appSettings.theme.secondaryColor);

    // Keep legacy pink variables for backward compatibility
