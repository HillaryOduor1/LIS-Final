...
const LoginPage: React.FC = () => {
    ...
    const from = (location.state && location.state.from && location.state.from.pathname) ? location.state.from.pathname : "/admin";

    const sanitizeInput = (input: string): string => {
        // Trim and remove any dangerous characters (basic)
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (mode === "login") {
            ...
            if (login(safeUsername, safePassword)) {
            ...
            <div className="w-full max-w-md p-8 bg-[var(--surface)] border border-[var(--border)] rounded-2xl shadow-xl transition-all">
                <div className="flex flex-col items-center gap-6">
                    ...
                    <form onSubmit={handleSubmit} className="w-full space-y-4">
                        {mode === "login" && (
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <label htmlFor="username" className="text-sm font-medium opacity-70">Username</label>
                                    <input
                                        id="username"
                                        type="text"
                                        placeholder="admin"
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between">
                                        <label htmlFor="password" className="text-sm font-medium opacity-70">Password</label>
                                        <button
                                            type="button"
                        ...
                        {mode === "forgot" && (
                            <div className="space-y-2">
                                <label htmlFor="reset-email" className="text-sm font-medium opacity-70">Email Address</label>
                                <input
                                    id="reset-email"
                                    type="email"
                        ...
                        {success && <p className="text-green-500 text-sm mt-1" role="status">{success}</p>}

                        <button
                            type="submit"
                            className="w-full py-3 bg-[var(--accent)] text-white font-semibold rounded-xl hover:filter hover:brightness-110 active:scale-[0.98] transition-all shadow-lg shadow-[var(--accent)]/20 focus:outline-none focus:ring-2 focus:ring-[var(--accent)] focus:ring-offset-2"
                        >
                        ...
                        {mode !== "login" && (
                            <button
                                ...
                                className="w-full text-sm text-[var(--muted)] hover:text-[var(--text)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--accent)] rounded"
                            >
                                Back to Login
                            </button>
                        )}
                    ...
                    {mode === "login" && (
                        <div className="w-full space-y-4">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 py-3 bg-white text-black border border-gray-300 font-semibold rounded-xl hover:bg-gray-50 active:scale-[0.98] transition-all focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
