...
// Main component – wraps the form with reCAPTCHA provider
...
function ArrowRightIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <path d="M5 12h14M13 5l6 7-6 7" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  );
}
...
const ContactForm = () => {
  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit} className="mt-12 md:mt-16 max-w-xl md:max-w-2xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-6 text-[var(--text)]">
      ...
      <div className="md:col-span-2 flex justify-start pt-4" data-animate>
        <button type="submit" disabled={loading} className="btn-primary w-full md:w-auto px-12 py-4 text-base disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
