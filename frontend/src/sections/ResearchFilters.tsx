...
const ResearchFilters = ({ activeFilter, setActiveFilter }: ResearchFiltersProps) => {
  const filters = ["All Areas", "Environment", "Natural Resources", "Land Governance", "Climate Policy"];
          ...
          {filters.map((filter) => {
            ...
            return (
              <button
                ...
                className={`flex h-10 shrink-0 items-center justify-center gap-x-2 rounded-full px-6 text-sm font-medium whitespace-nowrap transition-colors focus:outline-none focus:ring-2 focus:ring-primary ${
                  isActive ? "bg-primary text-background-dark font-bold" : "bg-primary/10 hover:bg-primary/20 text-[#0d1b14] dark:text-white"
                }`}
